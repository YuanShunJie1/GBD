...
def main():
    ...
    ubd = UBDDefense(device)
    avd, avd_time = attacker.backdoor_detection(ubd, dataloader_backdoor_test, poisoning_rate=args.pr,repeat_times=args.repeat, dataset=args.dataset)

    print('Dataset: ', args.dataset, ' Poisoning rate: ', args.pr, ' Backdoor detection accuracy: ', avd, 'Time comusption: ', avd_time)
