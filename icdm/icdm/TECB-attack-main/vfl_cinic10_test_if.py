...
def main(device, args):
    ...
    if not os.path.exists(f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_cinic10_{args.poisoning_rate}_{args.repeat}'):
        os.makedirs(f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_cinic10_{args.poisoning_rate}_{args.repeat}')
    
    avd = vfltrainer.test_backdoor_detection_mul_baseline(non_target_queue, criterion, device, args, delta, 0, udb, poison_rate=args.poisoning_rate, image_path=f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_cinic10_{args.poisoning_rate}_{args.repeat}')
    
    print("cinic10", args.poisoning_rate, args.repeat, "top1_acc: ", top1_acc, "top5_acc: ", top5_acc, "test_asr_acc: ", test_asr_acc, "backdoor_detection_acc", avd)
