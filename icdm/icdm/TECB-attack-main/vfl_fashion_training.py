...
from fedml_core.data_preprocessing.cifar10.dataset import IndexedCIFAR10, IndexedFashionMNIST
from fedml_core.model.baseline.vfl_models import BottomModelForCifar10, TopModelForCifar10, BottomModelForMnist, TopModelForMnist
...
def main(device, args):
    ...
    testset = IndexedFashionMNIST(root='./data', train=False, download=True, transform=test_transform)
    ...
    # ]
    optimizer_list = [
        torch.optim.Adam(model.parameters(), args.lr) for
        model
        in model_list
    ]
    ...
    if args.dataset in ['MNIST','FashionMNIST']:
        delta = torch.zeros((1, 1, args.half, x_val.shape[-2]), device=device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # print("Epoch:", epoch+1, "train_loss:", round(train_loss,2), "test_loss: ", round(test_loss,2), "acc: ", top1_acc, "test_asr_acc: ", round(test_asr_acc,2))
    ...
    checkpoint_path = args.save + f"/saved_models" + '/model_best.pth.tar'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', default='MNIST', type=str,
                        ...
                        choices=['CIFAR10','MNIST', 'CIFAR100', 'TinyImageNet', 'CINIC10L', 'Yahoo', 'Criteo', 'BCW'])
    ...
    parser.add_argument('--save', default='./model/FashionMNIST/checkpoint', type=str,
                        metavar='PATH',
