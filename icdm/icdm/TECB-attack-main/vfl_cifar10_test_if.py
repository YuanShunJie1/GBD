...
def main(device, args):
    ...
    train_queue = torch.utils.data.DataLoader(dataset=trainset, batch_size=args.batch_size, shuffle=True, num_workers=args.workers)
    test_queue = torch.utils.data.DataLoader(dataset=testset, batch_size=args.batch_size, num_workers=args.workers)
    non_target_queue = torch.utils.data.DataLoader(dataset=non_target_set, batch_size=args.batch_size, num_workers=args.workers)
    ...
    checkpoint_path = save_model_dir + "/checkpoint.pth"
    ...
    if not os.path.exists(f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_cifar10_{args.poisoning_rate}'):
        os.makedirs(f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_cifar10_{args.poisoning_rate}')

    device = next(model_list[0].parameters()).device
    udb = UBDDefense(device=device)
    
    if not os.path.exists(f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_cifar10_{args.poisoning_rate}_{args.repeat}'):
        os.makedirs(f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_cifar10_{args.poisoning_rate}_{args.repeat}')
    
    avd = vfltrainer.test_backdoor_detection_mul_baseline(non_target_queue, criterion, device, args, delta, 0, udb, poison_rate=args.poisoning_rate, image_path=f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_cifar10_{args.poisoning_rate}_{args.repeat}')
    
    print("cifar10", args.poisoning_rate, args.repeat, "top1_acc: ", top1_acc, "top5_acc: ", top5_acc, "test_asr_acc: ", test_asr_acc, "backdoor_detection_acc", avd)

    
    # print("test_loss: ", test_loss, "top1_acc: ", top1_acc,  "top5_acc: ", top5_acc, "test_asr_acc: ", test_asr_acc)
