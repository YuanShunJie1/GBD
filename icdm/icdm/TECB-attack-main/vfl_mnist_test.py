...
from fedml_core.data_preprocessing.cifar10.dataset import IndexedMNIST
...
def main(device, args):
    ...
    trainset = IndexedMNIST(root='./data', train=True, download=True, transform=train_transform)
    testset = IndexedMNIST(root='./data', train=False, download=True, transform=train_transform)
    ...
    if not os.path.exists(f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_mnist_{args.poisoning_rate}_{args.repeat}'):
        os.makedirs(f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_mnist_{args.poisoning_rate}_{args.repeat}')

    avd = vfltrainer.test_backdoor_detection_mul_baseline(non_target_queue, criterion, device, args, delta, 0, udb, poison_rate=args.poisoning_rate, image_path=f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_mnist_{args.poisoning_rate}_{args.repeat}')
    
    print("mnist", args.poisoning_rate, args.repeat, "top1_acc: ", top1_acc, "top5_acc: ", top5_acc, "test_asr_acc: ", test_asr_acc, "backdoor_detection_acc", avd)
...
if __name__ == '__main__':
    ...
    # config file
    parser.add_argument('--c', type=str, default='configs/base/mnist_bestattack.yml', help='config file')
