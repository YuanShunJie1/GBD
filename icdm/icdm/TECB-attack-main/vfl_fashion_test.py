...
def main(device, args):
    ...
    avd = vfltrainer.test_backdoor_detection_mul(non_target_queue, criterion, device, args, delta, 0, udb, poison_rate=args.poisoning_rate, image_path=f'/home/shunjie/codes/vfl_backdoor_defense/icdm/TECB-attack-main/images/image_fashionmnist_{args.poisoning_rate}_{args.repeat}')
